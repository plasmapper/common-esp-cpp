...
public:
  ...
  /// @brief Create a typed array buffer and allocate memory for its data
  ...
  /// @brief Create a typed array buffer with preallocated data
  /// @param data typed buffer data pointer
  /// @param arraySize array size
  ...
  /// @brief Create a typed array buffer with preallocated data and shared lockable
  /// @param data typed buffer data pointer
  /// @param arraySize array size
  /// @param lockable lockable object that is locked when this typed buffer is locked
