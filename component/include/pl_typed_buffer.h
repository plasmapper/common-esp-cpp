...
public:
  ...
  TypedBuffer() : Buffer (sizeof (Type)), data ((Type*)Buffer::data) {}

  /// @brief Create a typed buffer with preallocated data
  /// @param data typed buffer data pointer
  TypedBuffer (Type* data) : Buffer (data, sizeof (Type)), data (data) {}
  ...
  TypedBuffer (Type* data, std::shared_ptr<Lockable> lockable) : Buffer (data, sizeof (Type), lockable), data (data) {}
};
