...
## [2.2.0] - 2026-08-27
### Added
- TaskParameters::operator== and operator!=.

### Fixed
- StreamServer::SetStream and SetTaskParameters restarting the task even when the value did not change.

## [2.1.1] - 2026-08-24
### Fixed
- StreamServer destruction sequence.

## [2.1.0] - 2026-08-21
### Added
- Virtual destructors to Lockable and EventHandler.
- LockGuard::IsLocked.
- Lock timeout to LockGuard constructors.
...
- Event not releasing handlers whose objects have been destroyed.
